// LineScanSprint.tsx — STUB (v1.2'de implement edilecek)
...
const LineScanSprint: React.FC<Props> = ({ onExit }) => (
  <ComingSoonExercise title="Satır Tarama Koşusu" onExit={onExit} />
)

export default LineScanSprint
