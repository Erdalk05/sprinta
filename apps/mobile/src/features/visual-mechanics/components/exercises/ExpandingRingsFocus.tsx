// ExpandingRingsFocus.tsx — STUB (v1.2'de implement edilecek)
...
const ExpandingRingsFocus: React.FC<Props> = ({ onExit }) => (
  <ComingSoonExercise title="Genişleyen Halkalar Odağı" onExit={onExit} />
)

export default ExpandingRingsFocus
