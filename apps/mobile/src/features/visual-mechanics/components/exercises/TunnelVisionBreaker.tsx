// TunnelVisionBreaker.tsx — STUB (v1.2'de implement edilecek)
...
const TunnelVisionBreaker: React.FC<Props> = ({ onExit }) => (
  <ComingSoonExercise title="Tünel Görüş Kırıcı" onExit={onExit} />
)

export default TunnelVisionBreaker
