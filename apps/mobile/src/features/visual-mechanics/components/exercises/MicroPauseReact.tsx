// MicroPauseReact.tsx — STUB (v1.2'de implement edilecek)
...
const MicroPauseReact: React.FC<Props> = ({ onExit }) => (
  <ComingSoonExercise title="Mikro Duraklatma Tepkisi" onExit={onExit} />
)

export default MicroPauseReact
