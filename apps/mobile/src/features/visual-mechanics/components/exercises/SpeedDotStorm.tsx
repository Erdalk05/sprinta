// SpeedDotStorm.tsx — STUB (v1.2'de implement edilecek)
...
const SpeedDotStorm: React.FC<Props> = ({ onExit }) => (
  <ComingSoonExercise title="Hız Nokta Fırtınası" onExit={onExit} />
)

export default SpeedDotStorm
