// OppositePull.tsx — STUB (v1.2'de implement edilecek)
...
const OppositePull: React.FC<Props> = ({ onExit }) => (
  <ComingSoonExercise title="Karşıt Çekim" onExit={onExit} />
)

export default OppositePull
