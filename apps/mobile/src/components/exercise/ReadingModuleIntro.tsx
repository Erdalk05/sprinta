...
export const MODULE_INTRO: Record<string, ModuleInfo> = {
  ...
  'prediction-reading': {
    ...
    tip: 'Aktif okuyucular cümle sonunu önceden tahmin eder; bu öngörü becerisi okuma hızını ve kavramayı destekler.',
  ...
  'hatali-cumle': {
    ...
    benefits: ['Türkçe dil bilgisi kurallarını pekiştirir', 'Hata fark etme refleksini hızlandırır', 'LGS Türkçe dil bilgisi sorularına hazırlar'],
  ...
  'flashcard-bank': {
    ...
    tip: 'Serbest tempo + işaretleme sistemi: kartı çevir, bil/tekrar et.',
    benefits: ['LGS/TYT konuları kart formatında çalışılır', 'Bilmediğini işaretle, sonra tekrar et', 'Fen, Tarih, Coğrafya, Türkçe, Fizik kartları'],
  ...
  'poetry-analysis': {
    ...
    stats:    [{ label: 'Şiir', value: '7 adet' }, { label: 'Soru', value: 'Edebi sanat' }, { label: 'Hedef', value: 'AYT Ede.' }],
  },
  'daily-training': {
    icon: '🚀', label: 'Günlük Antrenman', accent: '#FF6B35',
    subtitle: 'Her gün bir metin seç · hızını ölç · anlama soruları',
    tip: 'Günlük düzenli pratik, WPM artışının en güvenilir yoludur.',
